...
namespace Duannoithat.Models.Services
{
    public class ShoppingCartRepository : IShoppingCartRepository
    {
        ...
        public ShoppingCartRepository(NoithatDbContext dbContext)
        {
        ...
        public static ShoppingCartRepository GetCart(IServiceProvider services)
        {
            ...
            NoithatDbContext context = services.GetService<NoithatDbContext>() ?? throw new Exception("Error initializing coffeeshopdbcontext");
